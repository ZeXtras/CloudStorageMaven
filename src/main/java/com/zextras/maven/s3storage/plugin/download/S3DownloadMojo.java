...
package com.zextras.maven.s3storage.plugin.download;
...
import com.zextras.maven.s3storage.KeyIteratorConcated;
import com.zextras.maven.s3storage.PathStyleEnabledProperty;
import com.zextras.maven.s3storage.plugin.PrefixKeysIterator;
    ...
    public void execute() throws MojoExecutionException {
        ...
        try {
            ...
            throw new MojoExecutionException(
              String.format(
                "Unable to authenticate to S3 with the available credentials. Make sure to either define the environment variables or System properties defined in https://docs.aws.amazon.com/AWSJavaSDK/latest/javadoc/com/amazonaws/auth/DefaultAWSCredentialsProviderChain.html.%n"
                  +
        ...
        Iterator<String> keyIteratorConcatenated = new KeyIteratorConcated(prefixKeysIterators);
