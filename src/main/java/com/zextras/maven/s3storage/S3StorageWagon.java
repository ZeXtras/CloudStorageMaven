...
import com.zextras.maven.s3storage.resolver.KeyResolver;
import com.zextras.maven.s3storage.transfer.TransferProgress;
import com.zextras.maven.s3storage.transfer.TransferProgressImpl;
import com.zextras.maven.s3storage.wagon.AbstractStorageWagon;
import com.zextras.maven.s3storage.wagon.PublicReadProperty;
import java.io.File;
...
public class S3StorageWagon extends AbstractStorageWagon {
    ...
    public void get(String resourceName, File file) throws TransferFailedException, ResourceDoesNotExistException {
        ...
        final TransferProgress transferProgress = new TransferProgressImpl(resource, TransferEvent.REQUEST_GET,
    ...
    public void put(File file, String resourceName) throws TransferFailedException {
        ...
        final TransferProgress transferProgress = new TransferProgressImpl(resource, TransferEvent.REQUEST_PUT,
          transferListenerContainer);
    ...
    public void connect(Repository repository, AuthenticationInfo authenticationInfo,
      ProxyInfoProvider proxyInfoProvider) throws AuthenticationException {
        ...
        s3StorageRepository.connect(authenticationInfo, region, new EndpointProperty(endpoint),
